...
class Idle:
    ...
    def do(self):
        ...
        if get_time() - self.boy.wait_time > 2:
            self.boy.state_machine.handla_event(('TIME_OUT', None))
    ...
    def draw(self):
        if self.boy.face_dir == 1:
            self.boy.image.clip_composite_draw(
                self.boy.frame * 100, 300, 100, 100, 3.14159/2,
                '', self.boy.x - 25, self.boy.y - 25, 100, 100)
        else:
            self.boy.image.clip_composite_draw(self.boy.frame * 100, 200, 100, 100, -3.14159/2,
            '', self.boy.x + 25, self.boy.y - 25, 100, 100)
...
class AutoRun:
    ...
    def draw(self):
        if self.boy.face_dir == 1:
            self.boy.image.clip_draw(self.boy.frame * 100, 100, 100, 100, self.boy.x, self.boy.y + 30, 150, 150)
        else:
            self.boy.image.clip_draw(self.boy.frame * 100, 0, 100, 100, self.boy.x, self.boy.y + 30, 150, 150)